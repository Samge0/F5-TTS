## docker of Ultralight-Digital-Human
...
- build docker
    ```shell
    docker build . -t samge/f5tts -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/f5tts
    ```
